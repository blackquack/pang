...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_Phaser__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game_js__ = __webpack_require__(6);
...
let config = {
    width: 800,
    height: 600,
    renderer: __WEBPACK_IMPORTED_MODULE_1_Phaser___default.a.AUTO
};

let game = new __WEBPACK_IMPORTED_MODULE_1_Phaser___default.a.Game(config);
game.state.add('gameState', __WEBPACK_IMPORTED_MODULE_2__game_js__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__objects_player_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__objects_weapon_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objects_monster_js__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends Phaser.State {
    ...
    create() {
        ...
        this.player = __WEBPACK_IMPORTED_MODULE_0__objects_player_js__["a" /* default */].create({ game: this });
        this.weapon = __WEBPACK_IMPORTED_MODULE_1__objects_weapon_js__["a" /* default */].create({ game: this });
        this.weapon.trackSprite(this.player);

        this.monsterGroup = this.add.group();
        this.monsterGroup.add(__WEBPACK_IMPORTED_MODULE_2__objects_monster_js__["a" /* default */].create({ game: this }));

        this.cursors = this.input.keyboard.createCursorKeys();
    }

    update() {
        if (this.cursors.up.isDown) this.camera.y -= 4;else if (this.cursors.down.isDown) this.camera.y += 4;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__monster_js__ = __webpack_require__(0);
